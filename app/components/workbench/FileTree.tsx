  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-gobezeai-elements-item-contentDefault hover:text-gobezeai-elements-item-contentActive hover:bg-gobezeai-elements-item-backgroundActive':
          !selected,
        'bg-gobezeai-elements-item-backgroundAccent text-gobezeai-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-gobezeai-elements-item-backgroundActive text-gobezeai-elements-item-contentDefault': !selected,
        'bg-gobezeai-elements-item-backgroundAccent text-gobezeai-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-gobezeai-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
